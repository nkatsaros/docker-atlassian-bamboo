...
const (
	archiveUrl = `https://my.atlassian.com/download/feeds/archived/bamboo.json`
	currentUrl = `https://my.atlassian.com/download/feeds/current/bamboo.json`
	eapUrl     = `https://my.atlassian.com/download/feeds/eap/bamboo.json`
)
